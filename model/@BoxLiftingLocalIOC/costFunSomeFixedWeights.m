function J = costFunSomeFixedWeights(obj, w)
%COSTFUNSOMEFIXEDWEIGHTS implements the outer loop cost function for the 
%weights w, allowing some weights to be constant.

% Initial joints
J = 0;

% Return w with the added fixed weights
w = obj.addFixedWeights(w);
