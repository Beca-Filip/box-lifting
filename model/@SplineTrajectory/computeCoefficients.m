...
% invA = A\logArrayToMat(b);
% if nBndCnd > 0
%     coefficients = invA(:, 1:end-nBndCnd) * obj.knotValues.' + invA(:, end-nBndCnd+1:end) * obj.boundaryConditions(:, 3:end);
% else
%     coefficients = invA * obj.knotValues.';
% end
% 
