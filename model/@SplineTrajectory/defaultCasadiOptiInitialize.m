function [obj, opti] = defaultCasadiOptiInitialize(opti, dimension, degree, knotNumber, evaluationNumber)
%DEFAULTCASADIOPTIINITIALIZE returns a SplineTrajectory object with default
